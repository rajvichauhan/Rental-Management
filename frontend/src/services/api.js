...
export const productsAPI = {
  ...
  getByCategory: (categoryId, params) =>
    api.get(`/products/categories/${categoryId}`, { params }),
  checkAvailability: (id, params) =>
    api.get(`/products/${id}/availability`, { params }),
  ...
  addInventory: (id, inventoryData) =>
    api.post(`/products/${id}/inventory`, inventoryData),
  updateInventory: (id, inventoryId, inventoryData) =>
    api.patch(`/products/${id}/inventory/${inventoryId}`, inventoryData),
  removeInventory: (id, inventoryId) =>
    api.delete(`/products/${id}/inventory/${inventoryId}`),
  addPricing: (id, pricingData) =>
    api.post(`/products/${id}/pricing`, pricingData),
  updatePricing: (id, ruleId, pricingData) =>
    api.patch(`/products/${id}/pricing/${ruleId}`, pricingData),
  deletePricing: (id, ruleId) =>
    api.delete(`/products/${id}/pricing/${ruleId}`),
...
export const ordersAPI = {
  ...
  processPickup: (id, pickupData) =>
    api.post(`/orders/${id}/pickup`, pickupData),
  processReturn: (id, returnData) =>
...
export const usersAPI = {
  ...
  addAddress: (id, addressData) =>
    api.post(`/users/${id}/addresses`, addressData),
  updateAddress: (id, addressId, addressData) =>
    api.patch(`/users/${id}/addresses/${addressId}`, addressData),
...
export const notificationsAPI = {
  ...
  unsubscribe: (subscriptionId) =>
    api.delete(`/notifications/subscribe/${subscriptionId}`),
};
